...
public class TradingStrategyProducerImpl implements TradingStrategyProducer {
    ...
    private RingBuffer<TradingEventMessage> ringBuffer;
    ...
    @Autowired
    public void setRingBuffer(RingBuffer<TradingEventMessage> ringBuffer) {
    ...
    public void produce(String exchange) {
        ...
        for (TradingStrategy strategy : strategies) {
            ...
            EventTranslator<TradingEventMessage> et = (tradingEventMessage, l) -> tradingEventMessage.setStrategy(strategy);
